...
# 1) 스케일 차이를 축소해준다. log(10)=1, 100은 2 ..
...
def test():
    ...
    print("상용로그: ", log10_values)
    log_values = np.log(values)   
    print("자연로그: ", log_values)
...
class LogTrans:
    # 편차가 큰 데이터를 로그스케일 변환하고 그 역변환을 제공하는 클래스
...
def main():
    ...
    data_log_scaled = log_trans.transform(data)                 # 로그변환
