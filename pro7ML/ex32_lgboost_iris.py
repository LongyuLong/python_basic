...
print(con_mat)
print((con_mat[0][0]+con_mat[1][1]+con_mat[2][2]) / len(y_test)) #0.955555
print()
...
joblib.dump(model, 'treemodel.pkl') # 확장자명은 sav, model... 이 3개가 일반적으로 많이 사용
del model
